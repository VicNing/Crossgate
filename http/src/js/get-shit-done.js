...
$(document).ready(function(){
    ...
    gsdk.burger_menu = $('nav[role="navigation"]').hasClass('navbar-burger') ? true : false;

    // Init navigation toggle for small screens
    if(window_width < 768 || gsdk.burger_menu){
        gsdk.initRightMenu();
    }
...
$(window).resize(function(){
    if($(window).width() < 768){
        gsdk.initRightMenu();
    } else if(!gsdk.burger_menu && gsdk.misc.navbar_menu_visible){
